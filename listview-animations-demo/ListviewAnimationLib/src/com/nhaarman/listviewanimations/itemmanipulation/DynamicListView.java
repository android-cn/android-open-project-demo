...
public class DynamicListView extends ListView {
     ...
     * @throws IllegalStateException if the adapter that was set does not implement {@link Insertable}.
     */
     ...
     * This method does nothing if no swipe functionality is enabled.
     *
     * @param position the position of the item in the {@link ListAdapter}. Must be visible.
     */
     ...
     *
     * @param position the position of the item in the {@link ListAdapter}. Must be visible.
     * @throws IllegalStateException if the {@link SwipeTouchListener}

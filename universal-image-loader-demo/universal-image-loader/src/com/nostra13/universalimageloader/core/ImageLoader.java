...
import com.nostra13.universalimageloader.core.assist.ImageTokenCallback;
...
public class ImageLoader {
    ...
    //自定义token callback
    private ImageTokenCallback tokenCallback;
	 ...
	 */
	public synchronized void init(ImageLoaderConfiguration configuration,ImageTokenCallback tokenCallback) {
    ...
    public String getToken(String url) {
        if (tokenCallback != null) return tokenCallback.getToken(url);
        else return "";
    }

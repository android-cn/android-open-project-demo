...
public abstract class BaseAdapterDecorator extends BaseAdapter implements SectionIndexer, Swappable, Insertable, ListViewWrapperSetter {
    ...
    /**
     * Returns the {@link ListViewWrapper} containing the ListView this {@code BaseAdapterDecorator} is bound to.
     */
    @Nullable
    ...
    /**
     * Alternative to {@link #setAbsListView(AbsListView)}. Sets the {@link ListViewWrapper} which contains the ListView

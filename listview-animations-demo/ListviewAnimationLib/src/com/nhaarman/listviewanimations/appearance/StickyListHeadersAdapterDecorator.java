...
/**
 * A {@link BaseAdapterDecorator} which can be used to animate header views provided by a
 * {@link StickyListHeadersAdapter}.
 */
public class StickyListHeadersAdapterDecorator extends BaseAdapterDecorator implements StickyListHeadersAdapter {
    ...
    /**
     * The decorated {@link StickyListHeadersAdapter}.
     */
    @NonNull
    private final StickyListHeadersAdapter mStickyListHeadersAdapter;

    /**
     * The {@link ViewAnimator} responsible for animating the Views.
     */
    @Nullable
    private ViewAnimator mViewAnimator;

    /**
     * Create a new {@code StickyListHeadersAdapterDecorator}, decorating given {@link BaseAdapter}.
     *
    ...
    /**
     * Sets the {@link StickyListHeadersListView} that this adapter will be bound to.
     */
    ...
    /**
     * Returns the {@link ViewAnimator} responsible for animating the header Views in this adapter.
     */
    @Nullable

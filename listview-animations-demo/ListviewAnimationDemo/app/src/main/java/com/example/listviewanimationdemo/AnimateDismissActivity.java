...
public class AnimateDismissActivity extends FragmentActivity {
    ...
    protected void onCreate(final Bundle savedInstanceState) {
        ...
        AlphaInAnimationAdapter alphaAnimation = new AlphaInAnimationAdapter(mAdapter);
        final SwipeDismissAdapter animateDismissAdapter = new SwipeDismissAdapter(alphaAnimation, new MyOnDismissCallback());

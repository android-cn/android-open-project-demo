...
/**
 * An adapter for inserting rows into the {@link ListView} with an animation. The root {@link BaseAdapter} should implement {@link Insertable},
 * otherwise an {@link IllegalArgumentException} is thrown. This class only works with an instance of {@code ListView}!
 * <p/>
 * Usage:<br>
 * - Wrap a new instance of this class around a {@link BaseAdapter}. <br>
 * - Set a {@code ListView} to this class using {@link #setListView(ListView)}.<br>
 * - Call {@link AnimateAdditionAdapter#insert(int, Object)} to animate the addition of an item.
 * <p/>
 * Extend this class and override {@link AnimateAdditionAdapter#getAdditionalAnimators(View,
 * ViewGroup)} to provide extra {@link Animator}s.
 */
public class AnimateAdditionAdapter<T> extends BaseAdapterDecorator {
    ...
    /**
     * Create a new {@code AnimateAdditionAdapter} with given {@link BaseAdapter}.
     *
    ...
    /**
     * @deprecated use {@link #setListView(ListView)} instead.
     */
    @Override
    @Deprecated
    ...
    /**
     * Sets the {@link ListView} that is used for this {@code AnimateAdditionAdapter}.
     */
